#> pk_racks:blocks/rack/actions/craft/trigger/dark_oak

# Remove advancement and recipe
advancement revoke @s only pk_racks:interactions/crafted_dark_oak_rack
recipe take @s pk_racks:dark_oak_rack
