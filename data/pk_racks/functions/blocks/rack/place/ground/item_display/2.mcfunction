#> pk_racks:blocks/rack/place/ground/item_display/2
...
# Place
# - West-East (X axis)
execute if score $facing pk.temp matches 0..1 run tp @s ~0.675 ~0.5 ~0.5
# - North-South (Z axis)
execute if score $facing pk.temp matches 2..3 run tp @s ~0.5 ~0.5 ~0.675