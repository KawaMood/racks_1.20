#> pk_racks:blocks/rack/place/ground/skins/block_display/4
...
data merge entity @s {transformation:{left_rotation:[0f,0f,-0.225f,0.974f],scale:[0.65f,1.0f,0.65f],translation:[-0.719f,-0.407f,0.094f]}}
