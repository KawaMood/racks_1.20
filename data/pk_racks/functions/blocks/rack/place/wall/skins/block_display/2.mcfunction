#> pk_racks:blocks/rack/place/wall/skins/block_display/2
...
# Set data
scoreboard players set $part pk.temp 2
function pk_racks:blocks/rack/place/wall/skins/add_parts_block_state
data merge entity @s {transformation:{left_rotation:[0f,0f,0.707f,0.707f],scale:[1.1f,1.1f,1.1f],translation:[0.85f,-0.715f,-0.5325f]}}
