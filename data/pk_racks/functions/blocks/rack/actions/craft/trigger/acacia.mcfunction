#> pk_racks:blocks/rack/actions/craft/trigger/acacia

# Remove advancement and recipe
advancement revoke @s only pk_racks:interactions/crafted_acacia_rack
recipe take @s pk_racks:acacia_rack
