#> pk_racks:blocks/rack/remove/block_list/remove_recursive
...
execute if data storage pk.common:data Temp.Array.Search[{}] run function pk_racks:blocks/rack/remove/block_list/remove_recursive