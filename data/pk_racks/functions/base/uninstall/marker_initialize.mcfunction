...
tag @s add pk.racks.uninstall.forceload_chunk
...
execute if score $temp pk.dimension.id matches -1 in minecraft:the_nether positioned as @s run function pk_racks:base/uninstall/forceload_custom_block_chunk
execute if score $temp pk.dimension.id matches 0 in minecraft:overworld positioned as @s run function pk_racks:base/uninstall/forceload_custom_block_chunk
execute if score $temp pk.dimension.id matches 1 in minecraft:the_end positioned as @s run function pk_racks:base/uninstall/forceload_custom_block_chunk
execute if score $temp pk.dimension.id matches 100.. at @e[type=marker,tag=pk.dimension.marker,predicate=pk_racks:scores/dimension_marker/matching_id] positioned as @s run function pk_racks:base/uninstall/forceload_custom_block_chunk