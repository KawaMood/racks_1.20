...
execute summon marker run function pk_racks:base/uninstall/marker_initialize

# Start process in the current chunk
function pk_racks:base/uninstall/chunk_check_state_recursive