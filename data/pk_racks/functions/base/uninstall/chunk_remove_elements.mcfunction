#> pk_racks:base/uninstall/chunk_remove_elements
...
execute as @e[type=marker,tag=pk.racks.rack.controller] at @s run function pk_racks:blocks/rack/remove/from_controller
...
execute if score $uninstall.remaining_chunks pk.value matches 0 run schedule function pk_racks:base/uninstall/stop 1t