#> pk_racks:blocks/rack/place/ground/skins/block_display/1
...
data merge entity @s {transformation:{left_rotation:[0.0f,0.0f,0.225f,0.974f],scale:[0.65f,1.0f,0.65f],translation:[0.135f,-0.677f,-0.7429f]}}
