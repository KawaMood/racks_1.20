#> pk_racks:blocks/rack/actions/craft/trigger/bamboo

# Remove advancement and recipe
advancement revoke @s only pk_racks:interactions/crafted_bamboo_rack
recipe take @s pk_racks:bamboo_rack
