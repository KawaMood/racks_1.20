#> pk_racks:blocks/rack/actions/craft/trigger/spruce

# Remove advancement and recipe
advancement revoke @s only pk_racks:interactions/crafted_spruce_rack
recipe take @s pk_racks:spruce_rack
