#> pk_racks:blocks/rack/actions/craft/trigger/warped

# Remove advancement and recipe
advancement revoke @s only pk_racks:interactions/crafted_warped_rack
recipe take @s pk_racks:warped_rack
