#> pk_racks:blocks/rack/place/wall/skins/block_display/3
...
# Set data
scoreboard players set $part pk.temp 3
function pk_racks:blocks/rack/place/wall/skins/add_parts_block_state
data merge entity @s {transformation:{left_rotation:[-0.383f,0f,0f,0.924f],scale:[0.5f,0.45f,0.5f],translation:[-0.55f,-0.47f,0.3375f]}}
