#> pk_racks:blocks/rack/place/ground/skins/block_display/5
...
data merge entity @s {transformation:{left_rotation:[0.707f,0f,0f,0.707f],scale:[0.26f,1.001f,0.65f],translation:[-0.25f,0.5f,-0.5f]}}
